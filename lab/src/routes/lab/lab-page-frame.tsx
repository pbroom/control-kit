...
function PrimitivePageViewTabs({
  getViewHref,
}: {
  getViewHref: (view: PrimitivePageView) => string;
}) {
  ...
  const docsView = (
    ...
    >
      <PagesPanel
        ...
        pages={pages}
      />
      <div className="mx-auto w-full max-w-[1440px] px-6 pb-24 sm:pt-24 sm:pr-10 sm:pl-[236px] lg:pr-16 lg:pl-[252px]">
        {docs}
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-[#171717] lg:overflow-hidden">
      <main
        ...
        style={
          {
            '--lab-properties-panel-width':
              isPropertiesPanelCollapsed || isDocsView ? '0px' : '300px',
          } as CSSProperties
        }
      >
